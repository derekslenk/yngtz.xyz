...
stats "csv/hankou.csv" using (column("timestamp")) name "timestamp" nooutput
set xdata time
...
set output "graphs/hankou.pdf"
plot "csv/hankou.csv" using (column("timestamp")+UTC_OFFSET*3600):"level" title 'Current level' with lines axes x1y1 lc rgb '#0000aa' lw 3, \
     "csv/hankou.csv" using (column("timestamp")+UTC_OFFSET*3600):"inflow" title 'Flow' with lines axes x1y2 lc rgb '#aa0000' lw 2

set xrange [timestamp_max-3*86400+UTC_OFFSET*3600:timestamp_max+UTC_OFFSET*3600]
set output "graphs/hankou-3d.pdf"
replot

set xrange [timestamp_max-86400+UTC_OFFSET*3600:timestamp_max+UTC_OFFSET*3600]
set output "graphs/hankou-24h.pdf"
replot
